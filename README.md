...
```bash
Install-Package SoloX.CodeQuality.Prod -version 2.0.15
or
Install-Package SoloX.CodeQuality.Test -version 2.0.15
```

**Install using the .Net CLI:**
```bash
dotnet add package SoloX.CodeQuality.Prod --version 2.0.15
or
dotnet add package SoloX.CodeQuality.Test --version 2.0.15
```

**Install editing your project file (csproj):**
```xml
<PackageReference Include="SoloX.CodeQuality.Prod" Version="2.0.15">
  <PrivateAssets>all</PrivateAssets>
  <IncludeAssets>runtime; build; native; contentfiles; analyzers</IncludeAssets>
</PackageReference>
or
<PackageReference Include="SoloX.CodeQuality.Test" Version="2.0.15">
  <PrivateAssets>all</PrivateAssets>
  <IncludeAssets>runtime; build; native; contentfiles; analyzers</IncludeAssets>
</PackageReference>
```
...
**Install using the command line from the Package Manager:**
```bash
Install-Package SoloX.CodeQuality.Test.Helpers -version 2.0.15

Install-Package SoloX.CodeQuality.Test.Helpers.XUnit -version 2.0.15

Install-Package SoloX.CodeQuality.Test.Helpers.NUnit -version 2.0.15
```

**Install using the .Net CLI:**
```bash
dotnet add package SoloX.CodeQuality.Test.Helpers --version 2.0.15

dotnet add package SoloX.CodeQuality.Test.Helpers.XUnit --version 2.0.15

dotnet add package SoloX.CodeQuality.Test.Helpers.NUnit --version 2.0.15
```

**Install editing your project file (csproj):**
```xml
<PackageReference Include="SoloX.CodeQuality.Test.Helpers" Version="2.0.15" />

<PackageReference Include="SoloX.CodeQuality.Test.Helpers.XUnit" Version="2.0.15" />

<PackageReference Include="SoloX.CodeQuality.Test.Helpers.NUnit" Version="2.0.15" />
```
